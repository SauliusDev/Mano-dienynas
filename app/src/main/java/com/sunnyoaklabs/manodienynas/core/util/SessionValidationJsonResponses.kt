...
object SessionValidationJsonResponses {
    ...
    const val CREDENTIALS_CORRECT_1 = "{\"message\":false,\"message_type\":0,\"url\":\"\\/1\\/lt\\/page\\/\\/sf\\/resolve_post\\/event\\/\\/list\"}"
    const val CREDENTIALS_CORRECT_2 = "{\"message\":false,\"message_type\":0,\"url\":\"\\/1\\/lt\\/page\\/message_new\\/message_list\"}"
