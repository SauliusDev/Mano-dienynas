...
class GetClassWorkByCondition(
    private val repository: Repository
) {

    operator fun invoke(payload: PostClassWork, page: Int): Flow<Resource<List<ClassWork>>> {
        return repository.getClassWorkByCondition(payload, page)
    }
